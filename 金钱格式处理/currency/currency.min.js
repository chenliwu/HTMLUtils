...
decimal:".",formatWithSymbol:!1,errorOnInvalid:!1,precision:2},q=/\.(\d+)$/,p=/(\d)(?=(\d{3})+\.)/g,n=/(\d)(?=(\d\d)+\d\.)/g;e.prototype={add:function(b){var a=this.s,c=this.p;return e((this.intValue+d(b,a))/c,a)},subtract:function(b){var a=this.s,c=this.p;return e((this.intValue-d(b,a))/c,a)},multiply:function(b){var a=this.s;return e(this.intValue*b/Math.pow(10,a.precision),a)},divide:function(b){var a=this.s;return e(this.intValue/d(b,a,!1),a)},distribute:function(b){for(var a=this.intValue,c=
this.p,g=this.s,d=[],f=Math[0<=a?"floor":"ceil"](a/b),h=Math.abs(a-f*b);0!==b;b--){var k=e(f/c,g);0<h--&&(k=0<=a?k.add(1/c):k.subtract(1/c));d.push(k)}return d},dollars:function(){return~~this.value},cents:function(){return~~(this.intValue%this.p)},format:function(b){var a=this.s,c=a.formatWithSymbol,d=a.symbol,e=a.separator,f=a.decimal;a=a.groups;"undefined"===typeof b&&(b=c);return((b?d:"")+this).replace(a,"$1"+e).replace(q,f+"$1")},toString:function(){var b=this.s,a=b.increment;return(Math.round(this.intValue/
